...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        weatherActionCat.setActions([socialAction, dismissAction], forContext: UIUserNotificationActionContext.Default)
        weatherActionCat.setActions([socialAction, dismissAction], forContext: UIUserNotificationActionContext.Minimal)
