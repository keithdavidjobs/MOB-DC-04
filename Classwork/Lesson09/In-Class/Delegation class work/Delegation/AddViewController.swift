...
class AddViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let myNotifications = NSNotificationCenter.defaultCenter()
        
        myNotifications.addObserver(self, selector: "changeColorBlue:", name: UIKeyboardDidShowNotification, object: nil)
        myNotifications.addObserver(self, selector: "changeColorRed:", name: UIKeyboardDidHideNotification, object: nil)
    }
    ...
    func changeColorBlue(notifyMeYo: NSNotification)
    {
        print("hey")
        self.nameField.backgroundColor = UIColor.blueColor()
    }
    
    func changeColorRed(notification: NSNotification)
    {
